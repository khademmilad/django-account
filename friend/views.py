...
# 	current_profile = Account.objects.get(pk=id)
#
# 	if request.method == 'POST' and 'send_request' in request.POST:
# 		request_sent,created = FriendRequest.objects.get_or_create(sender=account,receiver=current_profile)
...
def friend_requests(request,*args,**kwargs):
	...
	if user.is_authenticated:
		...
		if account == user:
			...
			return HttpResponse("You can't veiw another users friend requests.")
	else:
		redirect("login")
